...
namespace WebApplication1.Controllers
{
    public class GenerosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idGenero,GeneroNome")] Genero genero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idGenero,GeneroNome")] Genero genero)
        {
